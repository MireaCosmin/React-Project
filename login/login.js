...
export function Login() {
    ...
    return ( < >
            ...
            {
                isNotValid && ( < div className = "alert alert-danger" > Email and password are required < /div>)}

                        {
                            serverError && ( < div className = "alert alert-danger" > Server error: email or password is invalid < /div>)}
